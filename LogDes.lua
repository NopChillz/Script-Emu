...
task.spawn(function()
    while true do
		pcall(function()
            getgenv().SetDescription(CheckLevel() " | "..GetNewAwake().. " Beli : " ..game:GetService("Players").LocalPlayer.Data.Beli.Value.. " | F : " ..getgenv().Settings = {
                Show_Item_Settings = {
                    Godhuman = true,  -- true or false
                    Soul_Guitar = false,  -- true or false
                    Valkyrie_Helm = true,
            ...
            task.spawn(function()
                while true do
                    pcall(function()
                        getgenv().SetDescription(CheckLevel() " | "..GetNewAwake().. " Beli : " ..game:GetService("Players").LocalPlayer.Data.Beli.Value.. " | F : " ..game:GetService("Players").LocalPlayer.Data.Fragments.Value.. " | "..game:GetService("Players").LocalPlayer.Data.Race.Value.." ["..CheckRaceV().."]".." Melee : "..GetAllMeleeNew().." | World : "..WorldText..' | Fruits: '..GetFruitInU())
