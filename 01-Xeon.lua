_G.Setting = {
    ...
    ['Farm Fruit'] = {
        ...
        ['Select Fruit'] = {'Dark-Dark','Human-Human: Buddha','Light-Light','Dragon-Dragon','Mammoth-Mammoth','Dough-Dough','Leopard-Leopard'}, -- ผลรอง
...
script_key = "XiTpXlNuAHgnLKmMwkmlXQbymhCHbFTn"
