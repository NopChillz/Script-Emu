...
spawn(function()
    while true do wait()
        local x, p = pcall(function()
			Nexus:CreateButton("LogSheet", "Log Sheet", {100, 40})
...
Nexus:OnButtonClick('LogSheet', function() 
    pcall(function()
		...
		-- ส่ง HTTP POST request ไปยัง Sheet.Best API
		local response = HttpService:PostAsync(sheetBestUrl, jsonData, Enum.HttpContentType.ApplicationJson, false, {
