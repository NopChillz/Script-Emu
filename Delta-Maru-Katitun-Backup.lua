...
_G.Fruits_Settings = { -- ตั้งค่าผล
    ...
    ['Select_Fruits'] = {"Dark-Dark", "Dragon-Dragon", "Quake-Quake", "Light-Light", "Leopard-Leopard", "Buddha-Buddha","Kitsune-Kitsune","Dough-Dough","Dragon-Dragon"} -- กินหรือซื้อตอนไม่มีผล
}
